          ...
          <div class="productImagesSection">
            ...
            <div class="deliveryInfo">
              <div class="deliveryTypeInfo">
                ...
                <div class="deliveryTypeDescription">
                  ...
                  <div>
                    ...
                    <br />(주말/공휴일 주문건은 가장 빠른 영업일에 출발)
                  </div>
                </div>
                <div class="deliveryTypeDescription">
                  <div class="deliveryTypeDescriptionLabel">그 외 옵션 :</div>
                  <div>
              ...
              <div class="storeNoticeSection">
                <div class="storeNoticeTitle">브랜드에서 알려드려요</div>
                <div class="storeNoticeContents">
                  <p>
                    환경보호를 위해 포장 패키지는 주문번호당 1개씩 제공됩니다.
                    (주얼리 상자+품질보증서)
                  </p>
                  <p>
                  ...
                  <p>
                    * 주얼리 상자 추가 구매 및 리본 포장이 필요하신 경우, 문의글
                    혹은 카카오톡 채널 @딥브로우 로 남겨주시면 확인
                    도와드리겠습니다.
                  </p>
                  <p>
                    딥브로우의 모든 상품은 핸드크래프트 , 수작업으로 하나 하나
                    정성스럽게 제작됩니다.
                  </p>
                  <p>상품에 따라 제작에 2~7일(영업일 기준) 소요됩니다.</p>
                </div>
            ...
            <div class="productInfo">
              <div class="badge">
                <a href="#">
                  <div class="storeInfo">
                    <img
                      src="../../images/purchase/SAI_9656.jpeg"
                      alt="image"
                      class="storeImage"
                    />
              ...
              <div class="productOptionAndPrice">
                <div class="dropdownCoverSelector">
                  <div class="dropdownSelect">
                    <p class="dropdownSelectLabel">옵션 선택</p>
                    <img
        ...
        <div class="bottomSection">
          <div class="productDetailInfoSection">
            <div class="infoSectionTitle">
              <span class="productDetailSectionHead"> 상품 상세 정보 </span>
            </div>
            <div class="productDetailSectionContents">
              <div class="productDetailInfoItem">
                <div class="productDetailInfoItemLabel">카테고리</div>
                <div class="productDetailInfoItemContents">
                  목걸이, 이니셜목걸이, 하트목걸이, 서브펜던트, 아몬즈 단독,
                  오늘 출발, 베스트
                </div>
              </div>
              <div class="productDetailInfoItem">
                <div class="productDetailInfoItemLabel">소재/베이스</div>
                <div class="productDetailInfoItemContents">실버925</div>
              </div>
            </div>
          </div>
              ...
              <a href="#">
                <div class="productReviewItem">
                  ...
                  <div class="reviewContent">
                    친구에게 선물했는데 만족해했어요! 다음엔 제것도 하나 사고
                    싶습니다 ㅎㅎ
                  </div>
                </div>
              </a>
          ...
          <div class="recommendProductSection">
            <div class="recommendProductSectionTitle">비슷한 상품</div>
                  ...
                  <a href="#">
                    <div class="productListItemImg">
                      <img
                        ...
                        alt="image"
                      />
                      <div class="productName">Alice Heart Pearl Necklace</div>
                      <div class="productPrice">
                  ...
                  <a href="#">
                    <div class="productListItemImg">
                      <img
                        ...
                        alt="image"
                      />
                      <div class="productName">luv bracelet</div>
                      <div class="productPrice">
                  ...
                  <a href="#">
                    <div class="productListItemImg">
                      <img
                        ...
                        alt="image"
                      />
                      <div class="productName">Love pendant necklace</div>
                      <div class="productPrice">
      ...
      <div class="modalBackground">
        ...
        <div class="infoModal refundModal">
          ...
          <div class="infoModalContent">
            ...
            <h3>반품 / 교환 안내</h3>
            <p>
              어나더셀의 모든 제품은 주문제작으로 진행되어 주문 후 사이즈 변경
              및 환불이 어려운 참고 부탁드립니다.
            </p>
            <p>
              하단의 명시된 두 경우를 제외한 교환 및 환불이 어려운점 참고
              부탁드립니다.
            </p>
            <p>
              - 수령 받은 제품의 수작업 공정상 발생할 수 있는 미세 스크레치,
              이음새 자국은 불량에 포함되지 않습니다.
            </p>
            <p>- 주문건과 다른 오배송</p>
            ...
            <h3>- 제품의 하자나 기타 브랜드의 과실로 인한 반품 시 :</h3>
            <p>전액 환불해드립니다.</p>

            <h3>- 반품/교환 시 택배 발송 방법 :</h3>
            <p>
              상품을 받으신 택배사/송장번호로 반품 접수 해주세요. 다른 택배사로
              반품 접수하실 경우, 해당 반송 비용은 판매자가 책임지지 않습니다.
            </p>
          </div>
        </div>
        ...
        <div class="infoModal asModal">
          ...
          <div class="infoModalContent">
            <h3>A/S 안내</h3>
            <p>
              A/S 문의 게시판을 통해 글을 남겨주시면 A/S 가능 여부 확인 후
              연락드리겠습니다.
            </p>
            <p>
              -상품 부품 & A/S 종류에 따라 무상/유상 또는 A/S가 불가할 수
              있습니다.(왕복 택배비 고객님 부담)
            </p>
            <p>-은세척, 도금관련 A/S는 추가요금이 발생합니다.</p>

            <h3>착용시 주의 사항</h3>
            <p>은 자체가 무른 성질이 있으므로 착용시 주의하시기 바랍니다.</p>

            <h3>품질보증 기준</h3>
            <p>
              제품 구입 기간과 상관없이 A/S가 가능하나 상품 부품 & A/S 종류에
              따라 무상/유상 또는 A/S가 불가할 수 있습니다.
            </p>
          </div>
        </div>
        ...
        <div class="reviewModal">
          ...
          <button class="reviewWriteBtn">등록</button>
        </div>
      </div>
    </section>
